...
<head>
    ...
    <title> @yield('title', 'login') - Blog</title>
    <!-- Favicon icon -->
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                ...
                <div id="recoverform">
                    <div class="text-center">
                        <span class="text-white">Ingrese su correo electrónico a continuación y le enviaremos instrucciones sobre cómo recuperar una contraseña.</span>
                    </div>
                    <div class="row mt-3">
                        <!-- Form -->
                        <form class="col-12" action="index.html">
                            ...
                            <div class="row mt-3 pt-3 border-top border-secondary">
                                <div class="col-12">
                                    <a class="btn btn-success text-white" href="#" id="to-login" name="action">Regresar a Login</a>
